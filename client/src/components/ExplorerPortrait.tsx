...
export const EXPLORER_AVATARS: Record<AvatarKey, { src: string; role: "girl" | "boy" }> = {
  ...
  ember: { src: "/manus-storage/avatar-girl-sana-v2_9b4b0248.png", role: "girl" },
